...
const rawHeaders = {
  ...
  advertAliases = {
    'loan-requests': {type: 'loanRequest', alias: 'loan-requests', title: 'درخواست وام'},
    'loans': {type: 'loan', alias: 'loans', title: 'وام'},
    'finances': {type: 'finance', alias: 'finances', title: 'سرمایه گذاری'},
    'finance-requests': {type: 'financeRequest', title: 'درخواست سرمایه گذاری'},
    'co-signers': {type: 'coSigner', alias: 'co-signers', title: 'ضامن'},
    'co-signer-requests': {type: 'coSignerRequest', alias: 'co-signer-requests', title: 'درخواست ضامن'}
  },
  advertTypes = {
    'loanRequest': {type: 'loanRequest', alias: 'loan-requests', title: 'درخواست وام'},
    'loan': {type: 'loan', alias: 'loans', title: 'وام'},
    'finance': {type: 'finance', alias: 'finances', title: 'سرمایه گذاری'},
    'financeRequest': {type: 'financeRequest', alias: 'finance-requests', title: 'درخواست سرمایه گذاری'},
    'coSigner': {type: 'coSigner', alias: 'co-signers', title: 'ضامن'},
    'coSignerRequest': {type: 'coSignerRequest', alias: 'co-signer-requests', title: 'درخواست ضامن'}
  }
