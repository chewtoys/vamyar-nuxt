...
<script>
  ...
  const page_title = 'دسته بندی های مشاوره',
    categoriesMethod = '/admin/councilRequestTypes',
    breadcrumb = 'لیست دسته بندی ها',
    fetchPath = '/admin/councilRequestTypes',
    indexPath = '/admin/councils/categories',
    createPath = '/admin/councils/categories/create',
    headers = [
