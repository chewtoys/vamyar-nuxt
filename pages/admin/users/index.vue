      ...
      <div>
        ...
        <span slot="activator">
          ...
          <template slot="items" slot-scope="props">
            ...
            <td class="text-xs-right">
              {{ getProperty(props.item, 'details.firstName', '') + ' ' + getProperty(props.item, 'details.lastName', '-')}}
            </td>
            <td class="text-xs-right">
            ...
            <td class="text-xs-left">
              <nuxt-link title="مشاهده و ویرایش" :to=" uri + '/edit/' + props.item.id" class="mx-1">
                <v-icon
                  small
                >
                  edit
...
<script>
  ...
  const page_title = 'لیست کاربران',
    breadcrumb = 'کاربران سایت',
