...
<script>
  ...
  const page_title = 'انواع وام',
    categoriesMethod = '/loanTypes',
    breadcrumb = 'انواع وام',
    fetchPath = '/loanTypes',
    delPath = '/admin/loanTypes',
    indexPath = '/admin/settings/loan-types',
    createPath = '/admin/settings/loan-types/create',
    headers = [
