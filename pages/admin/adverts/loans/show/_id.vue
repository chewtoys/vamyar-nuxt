      ...
      <v-flex xs12 xl8>
        <v-card color="white">
          ...
          <div>
            ...
            <span class="left">
              <v-chip v-if="isUrgent" label color="red" text-color="white">
                <span calss="white--text">فوری</span>
                <v-icon left class="white--text">label</v-icon>
              </v-chip>
              <v-chip v-if="isUrgent" label color="green" text-color="white">
                <span calss="white--text">لیبل های دیگر</span>
                <v-icon left class="white--text">check_circle</v-icon>
              </v-chip>
              <v-chip v-if="isUrgent" label color="cyan" text-color="white">
                <span calss="white--text">لیبل های دیگر</span>
