      ...
      <v-layout row wrap>
        ...
        <v-flex xs12 md12 sm12 lg12>
          <form>
            ...
            <v-btn class="green" dark @click="submit" :loading="submit_loader">بروزرسانی
...
<script>
  ...
  // for change
  const path = "/user/details", page_title = 'ویرایش پروفایل', breadcrumb = "ویرایش مشخصات حساب کاربری";
  const info = {
