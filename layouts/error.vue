<template>
  <div class="rtl __nuxt-error-page">
    <div class="error ">
      <div v-if="statusCode === 404" class="title iransans">آدرس مورد نظر یافت نشد!</div>
      <div v-else-if="statusCode === 401" class="title iransans">شما به این صفحه دسترسی ندارید!</div>
