  ...
  <v-toolbar flat color="white" class="white grey--text" app>
    ...
    >
      <v-list color="second">
        ...
        >
          <v-list-tile-action>
            <v-icon v-text="'arrow_left'"></v-icon>
          </v-list-tile-action>
          <v-list-tile-title class="text-right rtl" v-text="item.title"></v-list-tile-title>
        </v-list-tile>
